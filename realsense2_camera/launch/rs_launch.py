...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'min_fps_threshold',            'default': '10.', 'description': 'Min frame publishing frequency threshold'},
                           {'name': 'max_fps_threshold',            'default': '10.', 'description': 'Max frame publishing frequency threshold'},
                          ]
